...
<template>
  <media-volume-slider
    class="hidden md:inline-flex group relative mx-[7.5px] h-10 w-full max-w-[80px] cursor-pointer touch-none select-none items-center outline-none aria-hidden:hidden"
  >
    <!-- Track -->
    <div
