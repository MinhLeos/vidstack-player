...
<template>
  <media-menu-button
    class="z-[9999] bg-black ring-media-focus parent left-0 flex w-full cursor-pointer select-none items-center justify-start rounded-sm p-2.5 outline-none ring-inset data-[open]:sticky data-[open]:-top-2.5 data-[hocus]:bg-white/10 data-[focus]:ring-[3px] aria-hidden:hidden aria-disabled:hidden"
  >
    <media-icon
